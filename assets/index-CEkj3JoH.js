(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const $l=()=>{};var Ir={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me=new ui("@firebase/app"),Wu="@firebase/app-compat",Vu="@firebase/analytics-compat",Hu="@firebase/analytics",$u="@firebase/app-check-compat",ju="@firebase/app-check",qu="@firebase/auth",Gu="@firebase/auth-compat",zu="@firebase/database",Ku="@firebase/data-connect",Yu="@firebase/database-compat",Qu="@firebase/functions",Ju="@firebase/functions-compat",Xu="@firebase/installations",Zu="@firebase/installations-compat",ed="@firebase/messaging",td="@firebase/messaging-compat",nd="@firebase/performance",id="@firebase/performance-compat",sd="@firebase/remote-config",rd="@firebase/remote-config-compat",od="@firebase/storage",ad="@firebase/storage-compat",cd="@firebase/firestore",ld="@firebase/vertexai",ud="@firebase/firestore-compat",dd="firebase",hd="11.7.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yi="[DEFAULT]",fd={[Ki]:"fire-core",[Wu]:"fire-core-compat",[Hu]:"fire-analytics",[Vu]:"fire-analytics-compat",[ju]:"fire-app-check",[$u]:"fire-app-check-compat",[qu]:"fire-auth",[Gu]:"fire-auth-compat",[zu]:"fire-rtdb",[Ku]:"fire-data-connect",[Yu]:"fire-rtdb-compat",[Qu]:"fire-fn",[Ju]:"fire-fn-compat",[Xu]:"fire-iid",[Zu]:"fire-iid-compat",[ed]:"fire-fcm",[td]:"fire-fcm-compat",[nd]:"fire-perf",[id]:"fire-perf-compat",[sd]:"fire-rc",[rd]:"fire-rc-compat",[od]:"fire-gcs",[ad]:"fire-gcs-compat",[cd]:"fire-fst",[ud]:"fire-fst-compat",[ld]:"fire-vertex","fire-js":"fire-js",[dd]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Na=new Map;function Pa(n,e){const t=di(n);Oa(t,e),Hd(t,e)}function Oa(n,e){const t=Na.get(n);if(t)for(const i of t)i(e)}function Hd(n,e){const t=$d();t&&t.postMessage({key:n,fid:e}),jd()}let He=null;function $d(){return!He&&"BroadcastChannel"in self&&(He=new BroadcastChannel("[Firebase] FID Change"),He.onmessage=n=>{Oa(n.data.key,n.data.fid)}),He}function jd(){Na.size===0&&He&&(He.close(),He=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wh{constructor(e){this.app=e}_delete(){return delete Gt[this.app.options.appId],Promise.resolve()}}let Gt={},Mr=[];const Lr={};let Li="dataLayer",Vh="gtag",xr,Wa,Fr=!1;function Hh(){const n=[];if(ca()&&n.push("This is a browser extension environment."),ru()||n.push("Cookies are not available."),n.length>0){const e=n.map((i,s)=>`(${s+1}) ${i}`).join(" "),t=G.create("invalid-analytics-context",{errorInfo:e});$.warn(t.message)}}function $h(n,e,t){Hh();const i=n.options.appId;if(!i)throw G.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)$.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw G.create("no-api-key");if(Gt[i]!=null)throw G.create("already-exists",{id:i});if(!Fr){wh(Li);const{wrappedGtag:r,gtagCore:o}=Sh(Gt,Mr,Lr,Li,Vh);Wa=r,xr=o,Fr=!0}return Gt[i]=Bh(n,Mr,Lr,e,xr,Li,t),new Wh(n)}function jh(n=Es()){n=L(n);const e=nt(n,Ln);return e.isInitialized()?e.getImmediate():qh(n)}function qh(n,e={}){const t=nt(n,Ln);if(t.isInitialized()){const s=t.getImmediate();if(De(e,t.getOptions()))return s;throw G.create("already-initialized")}return t.initialize({options:e})}function Gh(n,e,t,i){n=L(n),Fh(Wa,Gt[n.app.options.appId],e,t,i).catch(s=>$.error(s))}const Ur="@firebase/analytics",Br="0.10.15";function zh(){ce(new se(Ln,(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("installations-internal").getImmediate();return $h(i,s,t)},"PUBLIC")),ce(new se("analytics-internal",n,"PRIVATE")),Q(Ur,Br),Q(Ur,Br,"esm2017");function n(e){try{const t=e.getProvider(Ln).getImmediate();return{logEvent:(i,s,r)=>Gh(t,i,s,r)}}catch(t){throw G.create("interop-component-reg-failed",{reason:t})}}}zh();var Wr={};const Vr="@firebase/database",Hr="1.0.17";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ha=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Yh(e)}}catch{}return new Qh},$e=Ha("localStorage"),Jh=Ha("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pp{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function _p(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(rp(o.childName,o.snapshotNode))}),Ht(n,s,"child_removed",e,i,t),Ht(n,s,"child_added",e,i,t),Ht(n,s,"child_moved",r,i,t),Ht(n,s,"child_changed",e,i,t),Ht(n,s,"value",e,i,t),s}function Ht(n,e,t,i,s,r){const o=i.filter(a=>a.type===t);o.sort((a,c)=>mp(n,a,c)),o.forEach(a=>{const c=gp(n,a,r);s.forEach(l=>{l.respondsTo(a.type)&&e.push(l.createEvent(c,n.query_))})})}function gp(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function mp(n,e,t){if(e.childName==null||t.childName==null)throw Ot("Should only compare child_ events.");const i=new v(e.childName,e.snapshotNode),s=new v(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v_=/[\[\].#$\/\u0000-\u001F\u007F]/,I_=/[\[\].#$\u0000-\u001F\u007F]/,Vi=10*1024*1024,$c=function(n){return typeof n=="string"&&n.length!==0&&!v_.test(n)},jc=function(n){return typeof n=="string"&&n.length!==0&&!I_.test(n)},E_=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),jc(n)},qc=function(n,e,t,i){i&&e===void 0||Xs(vs(n,"value"),e,t)},Xs=function(n,e,t){const i=t instanceof b?new Bf(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Ve(i));if(typeof e=="function")throw new Error(n+"contains a function "+Ve(i)+" with contents = "+e.toString());if(ja(e))throw new Error(n+"contains "+e.toString()+" "+Ve(i));if(typeof e=="string"&&e.length>Vi/3&&li(e)>Vi)throw new Error(n+"contains a string greater than "+Vi+" utf8 bytes "+Ve(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(q(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!$c(o)))throw new Error(n+" contains an invalid key ("+o+") "+Ve(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Wf(i,o),Xs(n,a,i),Vf(i)}),s&&r)throw new Error(n+' contains ".value" child '+Ve(i)+" in addition to actual children.")}},Gc=function(n,e,t,i){if(!jc(t))throw new Error(vs(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},w_=function(n,e,t,i){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Gc(n,e,t)},Zs=function(n,e){if(y(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},C_=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!$c(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!E_(t))throw new Error(vs(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H_{constructor(e,t,i,s){this.eventType=e,this.eventRegistration=t,this.snapshot=i,this.prevName=s}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+D(this.snapshot.exportVal())}}class $_{constructor(e,t,i){this.eventRegistration=e,this.error=t,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ig(n){Kh(Mt),ce(new se("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return J_(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),Q(Vr,Hr,n),Q(Vr,Hr,"esm2017")}_e.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};_e.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};ig();function ar(n,e){var t={};for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&e.indexOf(i)<0&&(t[i]=n[i]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,i=Object.getOwnPropertySymbols(n);s<i.length;s++)e.indexOf(i[s])<0&&Object.prototype.propertyIsEnumerable.call(n,i[s])&&(t[i[s]]=n[i[s]]);return t}function il(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const sg=il,sl=new tt("auth","Firebase",il());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yg(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Qg(n){const e=$t(jt(n)).link,t=e?$t(jt(e)).deep_link_id:null,i=$t(jt(n)).deep_link_id;return(i?$t(jt(i)).link:null)||i||t||e||n}class fr{constructor(e){var t,i,s,r,o,a;const c=$t(jt(e)),l=(t=c.apiKey)!==null&&t!==void 0?t:null,u=(i=c.oobCode)!==null&&i!==void 0?i:null,d=Yg((s=c.mode)!==null&&s!==void 0?s:null);g(l&&u&&d,"argument-error"),this.apiKey=l,this.operation=d,this.code=u,this.continueUrl=(r=c.continueUrl)!==null&&r!==void 0?r:null,this.languageCode=(o=c.lang)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=Qg(e);try{return new fr(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hm=new yn(3e4,6e4);function Fo(){const n=ae().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function $m(n){return new Promise((e,t)=>{var i,s,r;function o(){Fo(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Fo(),t(oe(n,"network-request-failed"))},timeout:Hm.get()})}if(!((s=(i=ae().gapi)===null||i===void 0?void 0:i.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((r=ae().gapi)===null||r===void 0)&&r.load)o();else{const a=Mg("iframefcb");return ae()[a]=()=>{gapi.load?o():t(oe(n,"network-request-failed"))},Il(`${Dg()}?onload=${a}`).catch(c=>t(c))}}).catch(e=>{throw kn=null,e})}let kn=null;function jm(n){return kn=kn||$m(n),kn}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
